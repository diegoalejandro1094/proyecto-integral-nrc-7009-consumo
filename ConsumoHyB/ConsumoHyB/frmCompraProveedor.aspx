<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCompraProveedor.aspx.cs" Inherits="ConsumoHyB.frmCompraProveedor" MasterPageFile="~/Site1.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Mantenimiento de Compra Proveedor</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" />
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <h1>Registro de CompraProveedor (Maestro-Detalle)</h1>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <h4>Cabecera</h4>
                <div class="mb-2">
                    <asp:Label ID="lblCodProveedor" runat="server" Text="Proveedor:" CssClass="form-label"></asp:Label>
                    <asp:DropDownList ID="ddlCodProveedor" runat="server" CssClass="form-select"></asp:DropDownList>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    <asp:Label ID="lblDCodTipoHilo" runat="server" Text="Tipo Hilo:" CssClass="form-label"></asp:Label>
                    <asp:DropDownList ID="ddlDCodTipoHilo" runat="server" CssClass="form-select"></asp:DropDownList>
                </div>
                <div class="mb-2">
                ...
                <asp:GridView ID="gvDetalle" runat="server" AutoGenerateColumns="false" CssClass="table table-sm table-bordered" OnRowCommand="gvDetalle_RowCommand">
                    <Columns>
                        <asp:BoundField DataField="codTipoHiloTexto" HeaderText="Tipo Hilo" />
                ...
                <h5>Total:
                        <asp:Label ID="lblTotal" runat="server" Text="0.00"></asp:Label></h5>
                <asp:Button ID="btnRegistrar" runat="server" Text="Registrar CompraProveedor" CssClass="btn btn-primary" OnClick="btnRegistrar_Click" />
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <h4>CompraProveedors registrados</h4>
                <div class="table-responsive">
                    <asp:GridView ID="gvCompraProveedor" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered" OnRowCommand="gvCompraProveedor_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="codigo" HeaderText="Codigo" />
                            <asp:BoundField DataField="fecha" HeaderText="Fecha" />
                            <asp:BoundField DataField="codProveedor" HeaderText="Proveedor" />
