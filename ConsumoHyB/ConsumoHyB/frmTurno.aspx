<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTurno.aspx.cs" Inherits="ConsumoHyB.frmTurno" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Mantenimiento de Turno</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" crossorigin="anonymous" />
</head>
<body>
    <div class="container">
        <h1>Mantenimiento de Turno</h1>
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="mb-2">
                        <asp:Label ID="lblHoraInicio" runat="server" Text="Hora Inicio (hh:mm):" CssClass="form-label"></asp:Label>
                        <asp:TextBox ID="txtHoraInicio" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="mb-2">
                        <asp:Label ID="lblHoraFin" runat="server" Text="Hora Fin (hh:mm):" CssClass="form-label"></asp:Label>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="gvTurno" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered" OnRowCommand="gvTurno_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="codigo" HeaderText="Codigo" />
                            <asp:BoundField DataField="nombre" HeaderText="Nombre" />
                            <asp:BoundField DataField="horaInicio" HeaderText="Hora Inicio (hh:mm)" />
                            <asp:BoundField DataField="horaFin" HeaderText="Hora Fin (hh:mm)" />
