<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMoneda.aspx.cs" Inherits="ConsumoHyB.frmMoneda" MasterPageFile="~/Site1.Master" %>
    ...
    <div class="container">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="mb-2">
                    <asp:Label ID="lblSimbolo" runat="server" Text="Simbolo:" CssClass="form-label"></asp:Label>
                    <asp:TextBox ID="txtSimbolo" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <asp:GridView ID="gvMoneda" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered" OnRowCommand="gvMoneda_RowCommand">
                    <Columns>
