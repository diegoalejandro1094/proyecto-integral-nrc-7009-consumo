<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSalidaHilo.aspx.cs" Inherits="ConsumoHyB.frmSalidaHilo" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Mantenimiento de SalidaHilo</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" crossorigin="anonymous" />
</head>
<body>
    <div class="container">
        <h1>Mantenimiento de SalidaHilo</h1>
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="mb-2">
                        <asp:Label ID="lblCodProduccion" runat="server" Text="Produccion:" CssClass="form-label"></asp:Label>
                        <asp:DropDownList ID="ddlCodProduccion" runat="server" CssClass="form-select"></asp:DropDownList>
                    </div>
                    <div class="mb-2">
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gvSalidaHilo" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered" OnRowCommand="gvSalidaHilo_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="codigo" HeaderText="Codigo" />
                            <asp:BoundField DataField="fecha" HeaderText="Fecha" />
                            <asp:BoundField DataField="codProduccion" HeaderText="Produccion" />
