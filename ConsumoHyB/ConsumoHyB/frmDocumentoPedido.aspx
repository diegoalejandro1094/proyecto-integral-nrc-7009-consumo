<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDocumentoPedido.aspx.cs" Inherits="ConsumoHyB.frmDocumentoPedido" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Mantenimiento de DocumentoPedido</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" crossorigin="anonymous" />
</head>
<body>
    <div class="container">
        <h1>Mantenimiento de DocumentoPedido</h1>
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="mb-2">
                        <asp:Label ID="lblCodTipoDocumento" runat="server" Text="Tipo Documento:" CssClass="form-label"></asp:Label>
                        <asp:DropDownList ID="ddlCodTipoDocumento" runat="server" CssClass="form-select"></asp:DropDownList>
                    </div>
                    <div class="mb-2">
                        <asp:Label ID="lblNumero" runat="server" Text="Numero:" CssClass="form-label"></asp:Label>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gvDocumentoPedido" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered" OnRowCommand="gvDocumentoPedido_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="codigo" HeaderText="Codigo" />
                            <asp:BoundField DataField="codPedido" HeaderText="Pedido" />
                            <asp:BoundField DataField="codTipoDocumento" HeaderText="Tipo Documento" />
